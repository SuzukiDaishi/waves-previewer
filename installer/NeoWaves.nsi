...
;
; This installer is built for Windows. Keep source paths in native form because
; the Windows makensis File command does not resolve mixed or POSIX separators.

...
impl WavesPreviewer {
    pub(super) fn build_app(startup: StartupConfig, audio: AudioEngine) -> Self {
        ...
        let mut app = Self {
            ...
            status_palette: crate::app::status_tags::default_status_palette(),
            tag_palette: crate::app::status_tags::default_tag_palette(),
            default_status: None,
            status_tags_window_pos: None,
            status_tags_window_global_pos: None,
            ...
            editor_clear_edit_pending: None,
            ...
            show_status_tags_window: false,
            status_tags_window_on_tags: false,
            status_tags_pending_delete: None,
            ...
            session_disk_fingerprint: None,
            session_id: None,
            session_revision: None,
            session_display_name: None,
            session_paths_repaired: false,
            ...
            comments_detached: false,
            comment_draft: String::new(),
            comment_reply_to: None,
            comment_editing_id: None,
            comment_edit_draft: String::new(),
            comment_filter: Default::default(),
            comment_search: String::new(),
            comment_collapsed: Default::default(),
            pending_comment_jump: None,
            ...
            comment_path_index: Default::default(),
            comment_path_index_dirty: false,
            comment_path_index_stamp: (0, 0),
            comment_row_draft: String::new(),
            comment_row_draft_path: None,
